...
namespace Backrooms.MazeManager.Internal.Generation
{
    ...
    {
        /// <summary>Chooses where the up and down stairwells go.</summary>
        private readonly StairPlanner _stairs = new StairPlanner();
        ...
        public MazeLayout Generate(MazeSettings settings)
        {
            ...
            // Carve from a fixed corner; where the player actually arrives is decided later, once
            // the up stairwells are placed.
            var carveFrom = new Vector2Int(0, 0);

            var stack = new Stack<Vector2Int>();
            visited[Index(carveFrom.x, carveFrom.y, w)] = true;
            stack.Push(carveFrom);
